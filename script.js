...
function editNote(id) {
  ...
  document.getElementById('formEyebrow').textContent = 'Edit Note';
...
function renderNotes() {
  ...
  if (filtered.length === 0) {
    ...
    empty.querySelector('p').textContent  = query ? `No notes matching "${query}"` : 'Tap + to write your first note!';
    return;
  }
...
// Enter key — title se body pe focus
